Import project in eclipse with dependency sources, code style, auto formatter, pmd, checkstyle and m2eclipse as maven manager

   * first run this command : # mvn -P eclipseplugin -U eclipse:clean eclipse:eclipse generate-resources
   * import your project as m2eclipse maven project
