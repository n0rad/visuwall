	...
	<div style="display:none" id="formCreation">
		...
		<div id="softTabs"> 
			...
			<div id="tabs-0"> 
				...
				<label for="softwareAccesses0.projectFinderDelaySecond">Software Refresh Time <span>42</span>(s)</label> 
				<input id="softwareAccesses0.projectFinderDelaySecond" name="softwareAccesses[0].projectFinderDelaySecond" class="ui-widget-content ui-corner-all disabled" value=""/> 
				<label for="softwareAccesses0.projectStatusDelaySecond">Project Refresh Time <span>42</span>(s)</label> 
				<input id="softwareAccesses0.projectStatusDelaySecond" name="softwareAccesses[0].projectStatusDelaySecond" class="ui-widget-content ui-corner-all disabled" value=""/> 
			</div> 
		</div>
