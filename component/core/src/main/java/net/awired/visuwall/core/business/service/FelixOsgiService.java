...
public class FelixOsgiService implements PluginServiceInterface {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(FelixOsgiService.class);
    ...
    public void launchOsgiContainer() {
        ...
        String bundleDir = System.getProperty(ApplicationHelper.HOME_KEY) + "/bundle";
        String cacheDir = System.getProperty(ApplicationHelper.HOME_KEY) + "/cache";
        ...
        properties.put(AutoProcessor.AUTO_DEPLOY_ACTION_PROPERY, "install,start");
        ...
        try {
            ...
            for (File file : listFiles) {
                try {
                    m_activator.getContext().installBundle("file:" + file.getAbsolutePath());
