...
public class Main2 {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            System.err.println("Jwall requires Java5 or later.");
            e.printStackTrace();
        }
    }
    ...
    private static String getVersion(String fallback) throws IOException {
        Enumeration manifests = Main2.class.getClassLoader().getResources("META-INF/MANIFEST.MF");
    ...
    public static File whoAmI() throws IOException, URISyntaxException {
        ...
        try {
            URL classFile = Main2.class.getClassLoader().getResource("Main.class");
        ...
        myself.deleteOnExit();
        InputStream is = Main2.class.getProtectionDomain().getCodeSource().getLocation().openStream();
        try {
    ...
    private static File extractFromJar(String resource, String fileName, String suffix) throws IOException {
        URL res = Main2.class.getResource(resource);
