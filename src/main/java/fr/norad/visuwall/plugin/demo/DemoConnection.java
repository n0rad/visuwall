...
import static fr.norad.visuwall.domain.BuildState.UNSTABLE;
...
import fr.norad.visuwall.domain.quality.QualityMeasure;
import fr.norad.visuwall.domain.quality.QualityMetric;
...
public class DemoConnection implements BuildCapability, TestCapability, ViewCapability, MetricCapability {
    ...
    public DemoConnection() {
        softwareProjectIds.put(SoftwareProjectIds.moon, "Moon");
        softwareProjectIds.put(SoftwareProjectIds.earth, "Earth");
        softwareProjectIds.put(SoftwareProjectIds.mars, "Mars");
        softwareProjectIds.put(SoftwareProjectIds.pluto, "Pluto");
        softwareProjectIds.put(SoftwareProjectIds.neptune, "Neptune");
        softwareProjectIds.put(SoftwareProjectIds.uranus, "Uranus");
        softwareProjectIds.put(SoftwareProjectIds.saturn, "Saturn");
        softwareProjectIds.put(SoftwareProjectIds.mercury, "Mercury");
        softwareProjectIds.put(SoftwareProjectIds.venus, "Venus");

        buildStates.put(SoftwareProjectIds.mars, FAILURE);
        buildStates.put(SoftwareProjectIds.pluto, UNKNOWN);
        buildStates.put(SoftwareProjectIds.uranus, SUCCESS);
        buildStates.put(SoftwareProjectIds.neptune, SUCCESS);
        buildStates.put(SoftwareProjectIds.saturn, UNSTABLE);
        buildStates.put(SoftwareProjectIds.venus, UNSTABLE);
        buildStates.put(SoftwareProjectIds.moon, SUCCESS);
        buildStates.put(SoftwareProjectIds.earth, SUCCESS);
        buildStates.put(SoftwareProjectIds.mercury, SUCCESS);
        ...
        unitTestResults.put(SoftwareProjectIds.saturn, saturnTestResults);
        unitTestResults.put(SoftwareProjectIds.neptune, neptuneTestResults);
        unitTestResults.put(SoftwareProjectIds.mercury, mercuryTestResults);
        unitTestResults.put(SoftwareProjectIds.venus, venusTestResults);
        ...
        integrationTestResults.put(SoftwareProjectIds.neptune, neptuneIntegrationTestResults);
        integrationTestResults.put(SoftwareProjectIds.mercury, mercuryIntegrationTestResults);
        integrationTestResults.put(SoftwareProjectIds.venus, venusIntegrationTestResults);
        ...
        qualityResults.put(SoftwareProjectIds.uranus, uranusQualityResult);
        qualityResults.put(SoftwareProjectIds.mercury, mercuryQualityResult);
    ...
    public List<SoftwareProjectId> findSoftwareProjectIdsByViews(List<String> views) {
        ...
        if (views.contains("Telluriques")) {
            softwareProjectIds.add(SoftwareProjectIds.earth);
        }
        return softwareProjectIds;
    }
    ...
    public List<Commiter> getBuildCommiters(SoftwareProjectId softwareProjectId, String buildId)
        ...
        if (softwareProjectId.equals(SoftwareProjectIds.mars)) {
    ...
    public List<String> getBuildIds(SoftwareProjectId softwareProjectId) throws ProjectNotFoundException {
        if (SoftwareProjectIds.mars.equals(softwareProjectId)) {
    ...
    public BuildState getBuildState(SoftwareProjectId projectId, String buildId) throws ProjectNotFoundException,
        ...
        if (SoftwareProjectIds.mars.equals(projectId)) {
    ...
    public Date getEstimatedFinishTime(SoftwareProjectId projectId, String buildId) throws ProjectNotFoundException,
            BuildNotFoundException {
        if (projectId.equals(SoftwareProjectIds.mars)) {
            return marsProj.estimatedFinishTime();
        }
        if (projectId.equals(SoftwareProjectIds.moon)) {
