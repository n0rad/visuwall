/*
 * $Id: ELTextareaTagBeanInfo.java 479635 2006-11-27 14:27:18Z pbenedict $
 *
...
public class ELTextareaTagBeanInfo extends SimpleBeanInfo {
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            proplist.add(new PropertyDescriptor("dir", ELTextareaTag.class,
                    null, "setDirExpr"));
        } catch (IntrospectionException ex) {
        }
        ...
        try {
            proplist.add(new PropertyDescriptor("lang", ELTextareaTag.class,
                    null, "setLangExpr"));
        } catch (IntrospectionException ex) {
        }
